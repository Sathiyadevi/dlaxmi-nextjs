...
xl:h-[400px] xl:w-[400px] rounded-full bg-gradient-to-br ${domain.color} p-[2px] shadow-[0_0_80px_rgba(99,102,241,0.15)]`}>
                        <motion.div
                        animate={{ rotate: 360 }}
                        transition={{
                            duration: 40,
...
xl:h-[430px] xl:w-[430px] rounded-full border border-indigo-200/40"
                        />
...
xl:h-[340px] xl:w-[340px] rounded-full border border-cyan-200/50"
                        />
